  ...
  return (
    <section className="section">
      <div className="section-center">
        {people.map((item, indexPeople) => {
          ...
          return (
            <article key={id} className={position}>
              <p className="md:text-xl text-sm bg-primary px-10 py-5 md:mb-7 mb-3 rounded-xl text-white text-center font-third">
                {text}
              </p>
              <div className="text-right md:text-xl text-md flex flex-col">
        ...
        <button className="prev left-5" onClick={() => setIndex(index - 1)}>
        ...
        <button className="next right-5" onClick={() => setIndex(index + 1)}>
