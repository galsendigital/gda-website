...
const Footer = () => {
  ...
  return (
    <section className="relative">
      ...
      <div className="flex flex-col items-center text-center 2xl:text-4xl lg:justify-between lg:flex-row bg-tertiary text-white md:text-xl text-xs md:px-10 md:py-8 px-5 py-5">
