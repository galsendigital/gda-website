  ...
  return (
    <section className="relative">
      <a
        id="btn"
        href="#accueil"
        className="absolute left-[50%] transform translate-x-[-50%] bottom-2 md:hidden flex flex-col items-center text-white"
      >
        <svg
      ...
      <div className="bg-primary w-full ">
        <div className=" xl:w-4/5 mx-auto text-white flex flex-col justify-center lg:justify-between lg:flex-row items-center md:px-10 px-5 md:py-8 py-5">
      ...
      <div className="bg-tertiary w-full">
        <div className="flex flex-col items-center text-center 2xl:text-xl lg:justify-between lg:flex-row xl:w-4/5 mx-auto text-white md:text-xl text-xs md:px-10 md:py-8 px-5 py-5">
          <p>
            © 2020 - {thisYear} Galsen Digital Agency. Tous Droits Réservés.
          </p>
          <p className="pb-7 md:pb-0">Site Développé Et Déployé Par La GDA</p>
        </div>
      </div>
    </section>
  );
