  ...
  return (
    <section id="services">
      <div className="flex flex-col items-center bg-gradient3 text-white md:px-10 px-5 md:py-14 py-7">
        <h2 className="font-bold md:text-3xl 2xl:text-5xl text-xl text-center font-second pb-10">
          EN PLUS DE LA CRÉATION DE SITES / APPLICATIONS WEB,
          <br /> L’AGENCE PROPOSE ÉGALEMENT DES SERVICES DE :
        </h2>
        <div className="flex flex-col gap-y-9 gap-x-9 2xl:justify-between lg:flex-row md:justify-center w-full xl:w-4/5">
          <div>
            <div className="flex flex-col items-center">
              <div className="mb-5 bg-primary rounded-md p-1 2xl:mb-10">
                <img src={brush} alt="paint brush" className="w-10 2xl:w-16" />
              </div>
              <h3 className="md:text-md 2xl:text-3xl font-bold border-b-4 border-tertiary mb-3 md:mb-8">
                GRAPHISME
              </h3>
          ...
          <div className="">
            <div className="flex flex-col items-center">
              <div className="mb-5 bg-primary rounded-md p-1 2xl:mb-10">
                <img src={archery} alt="archery" className="w-10 2xl:w-16" />
              </div>
              <h3 className="md:text-md 2xl:text-3xl font-bold text-center border-b-4 border-tertiary mb-3 md:mb-8">
          ...
          <div className="">
            <div className="flex flex-col items-center">
              <div className="mb-5 bg-primary rounded-md p-1 2xl:mb-10">
                <img src={hat} alt="degree hat" className=" w-10 2xl:w-16" />
              </div>
              <h3 className="md:text-md 2xl:text-3xl font-bold border-b-4 border-tertiary mb-3 md:mb-8">
                FORMATION
              </h3>
